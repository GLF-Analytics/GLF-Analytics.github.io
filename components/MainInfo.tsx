...
function MainInfo(){
  ...
  return (
    <div className="bg-black w-full flex flex-col justify-center min-h-screen">
      ...
      <div className="bg-Eerie-black max-h-[90vh] rounded-xl z-[0] text-Magnolia p-8 w-[60%] self-center flex flex-col justify-center" style={taviraj_title.style}>
        <div className="h-full">
          <Accordion type="single" collapsible className="">
            <AccordionItem value="FAQ" className="text-center text-5xl pb-12">FAQ</AccordionItem>
            {data}
          </Accordion>
        </div>
      </div>
