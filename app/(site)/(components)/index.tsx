  ...
  return (
    <div style={taviraj_title.style}>
      ...
      <div className="relative mt-[35vh] mb-[60vh] flex justify-center items-center">
        <div data-scroll data-scroll-speed="0.4" className="absolute w-[1400px] h-[475px] opacity-90 brightness-70 bg-Eerie-black"></div>
        <div className="z-[3] relative text-Magnolia text-center uppercase">
