...
export default function Index(){
  return (
    <div style={taviraj_title.style} className="h-screen flex justify-center">
      ...
      <div className="relative flex flex-col justify-center items-center -mt-24">
        ...
        <div className="z-[3] relative text-Magnolia text-center uppercase flex flex-col items-center justify-center">
          ...
          <div data-scroll data-scroll-speed="0.4" className="text-4xl mt-16 border-2 rounded-md flex brightness-70 bg-Eerie-black flex-col justify-center p-4 lowercase">
            <TypeAnimation
              sequence={[
